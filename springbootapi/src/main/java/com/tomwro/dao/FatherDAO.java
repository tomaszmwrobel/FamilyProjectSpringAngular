...
public class FatherDAO implements IFatherDAO {
	...
	public void addFather(Father father) {
		...
		jdbcTemplate.update(sql, father.getFatherId(), father.getBirthDate(), father.getFirstName(),
				father.getSecondName(), father.getPESEL());
	...
	public void updateFather(Father father) {
		...
		jdbcTemplate.update(sql, father.getBirthDate(), father.getFirstName(), father.getSecondName(),
				father.getPESEL(), father.getFatherId());
